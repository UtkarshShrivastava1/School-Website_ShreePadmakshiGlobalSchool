      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-2 sm:px-6 lg:px-5">
          ...
          <p className="mt-6 max-w-2xl text-xl">
            Classes VI - VIII: Guiding students toward independent learning and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700">
              ...
              experiences in life and the courses of the study. The learner is
              equipped with 'learning skills' and is ready to move on to the
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              We aim to prepare our children to be healthy and active with a
              passion for developing their physical abilities and to achieve
              high standards and high levels of attainment in academics, and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600">
                Students are guided to take responsibility for their own
            ...
            <div className="bg-white p-6 rounded-lg shadow-md transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600">
                Students begin to understand their role in the larger community
                and society.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600">
                CCE methodology ensures holistic assessment of each student's
                progress.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-gray-700 mb-6">
              The evaluation is done through CCE i.e. Continuous & Comprehensive
              Evaluation. It consists of cycle tests, programmed curricular
              activities and projects to assess children holistically which are
              conducted time to time.
            </p>
            <p className="text-lg text-gray-700 mb-6">
              This makes the child constantly alert about his performance
              without any laxity.
            </p>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <p className="text-gray-700">
                  Regular cycle tests to assess academic progress
                </p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 h-6 w-6 rounded-full bg-indigo-100 flex items-center justify-center mr-3 mt-1">
                ...
                <p className="text-gray-700">
                  Project-based assessments to develop practical skills
                </p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 h-6 w-6 rounded-full bg-indigo-100 flex items-center justify-center mr-3 mt-1">
                ...
                <p className="text-gray-700">
                  Programmed curricular activities for holistic development
                </p>
              </li>
              <li className="flex items-start">
                <div className="flex-shrink-0 h-6 w-6 rounded-full bg-indigo-100 flex items-center justify-center mr-3 mt-1">
                ...
                <p className="text-gray-700">
                  Continuous feedback to ensure consistent improvement
                </p>
              </li>
            </ul>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              We understand the importance of competitions for the children
              especially as they progress and develop through the school.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Students compete in various sports activities including cricket,
                football, basketball, athletics, and more.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Students showcase their intellectual abilities through debates,
                quizzes, science exhibitions, and more.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full mr-2"></div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-600 mb-4">
                Students express their creativity through dance, music, art,
                dramatics, and other cultural activities.
              </p>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full mr-2"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-6">
                The Middle School Program equips students with essential
                'learning skills' that prepare them for the challenges of
                secondary education.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              Hear from our community about their experiences with the Middle
              School Program
            </p>
          </div>
      ...
      <section className="py-12 bg-indigo-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Ready to join our Middle School Program?
          </h2>
          <p className="text-lg text-gray-600 mb-8 max-w-3xl mx-auto">
            Contact us today to learn more about admissions for Classes VI -
            VIII.
          </p>
