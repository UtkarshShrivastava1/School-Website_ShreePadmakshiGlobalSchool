      ...
      <header className="bg-gradient-to-r from-purple-800 to-indigo-700 text-white">
        <div className="container mx-auto px-4 py-20 max-w-7xl">
          ...
          <p className="text-xl md:text-2xl text-center max-w-3xl mx-auto opacity-90">
            Explore the exceptional facilities at SPGS designed to nurture
            well-rounded, creative, and confident individuals.
          </p>
        </div>
        ...
        <div className="h-16 bg-gradient-to-r from-purple-800 to-indigo-700 relative">
          <div
            className="absolute bottom-0 left-0 w-full h-16 bg-indigo-50"
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white py-16">
        <div className="container mx-auto px-4 max-w-5xl text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-8 opacity-90">
            See our world-class facilities in person and discover how SPGS can
            provide your child with an exceptional education.
          </p>
