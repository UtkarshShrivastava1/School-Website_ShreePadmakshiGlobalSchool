        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-8">
              Discover rewarding career opportunities for dedicated education
              professionals
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="space-y-4 text-slate-600">
              <p>
                Shree Padmakshi Global School is committed to enhance the
                educational opportunities for dedicated professionals like you
                who have a requisite degree in Early Childhood Care & Education
                and are keen to be a part of unique culture.
              </p>
              <p>
                Shree Padmakshi Global School professionals enjoy careers that
                are both challenging and rewarding.
              </p>
              <p>
                Everything does is intentional, deeply rooted in the foundation
                of its Mission, Values, Purpose, and Service culture.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="border-t-4 border-t-orange-600">
                ...
                <CardContent>
                  <p className="text-sm text-slate-600">
                    Our commitment to lifetime learning extends to our employees
                    through supporting staff in their individual and
              ...
              <Card className="border-t-4 border-t-orange-600">
                ...
                <CardContent>
                  <p className="text-sm text-slate-600">
                    We offer education assistance programs, professional
                    development programs, and ongoing career development
                    opportunities.
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 md:p-8 border border-slate-200">
            ...
            <Tabs defaultValue="email">
              <TabsList className="grid w-full grid-cols-2 mb-6 bg-slate-100 rounded-md">
                <TabsTrigger
                  value="email"
                  className="data-[state=active]:bg-white data-[state=active]:text-orange-600 cursor-pointer "
                >
                  Email Application
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="email" className="space-y-4">
                <p className="text-slate-600">
                  Send us your CV / Biodata to the email address below. If your
                  skills match our requirements, get ready for a rewarding
                  career that can transform your life.
                </p>
                <div className="flex items-center gap-2 p-3 bg-slate-100 rounded-md">
                  <Mail className="h-5 w-5 text-orange-600" />
                  <a
                    href="mailto:career@spgsbilaspur.com"
                    className="text-orange-600 font-medium"
                  >
                    career@spgsbilaspur.com
                  </a>
                </div>
              </TabsContent>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="border-slate-300 focus:border-orange-600 focus:ring-orange-600"
                      />
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-indigo-900">
              Why Join Shree Padmakshi Global School?
            </h2>
            <p className="text-slate-600">
              If you share our vision of child centric education, we would like
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border border-slate-200 hover:shadow-md transition-all">
              ...
              <CardContent>
                <p className="text-slate-600">
                  Regular faculty training programs and numerous ongoing career
                  development opportunities to help you grow professionally.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border border-slate-200 hover:shadow-md transition-all">
              ...
              <CardContent>
                <p className="text-slate-600">
                  Join a team of dedicated educators who are passionate about
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-200 mb-8">
              Shree Padmakshi Global School and be part of our mission to
              provide child-centric education that shapes the future.
            </p>
