      ...
      <div className="relative bg-gradient-to-r from-blue-900 to-indigo-800 text-white">
        ...
        <div className="relative container mx-auto px-6 py-32 text-center">
          ...
          <div className="mt-10 flex justify-center">
            <a
              href="#vision"
              className="animate-bounce bg-gray-400 bg-opacity-20 p-3 rounded-full"
            >
              <svg
                className="w-6 h-6"
                fill="none"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We are committed to providing a holistic education that nurtures
              the intellectual, physical, emotional, and spiritual growth of
              every child.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "To prescribe and implement a curriculum for physical, mental, emotional, spiritual and intellectual enlistment for achieving multifaceted development and growth of the younger generation.",
                icon: "🧠",
              },
              {
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Discover how our approach to education can help your child thrive
