  ...
  const values = [
    {
      ...
      description: "We strive for excellence in all aspects of education, challenging our students to reach their highest potential academically, socially, and emotionally.",
      examples: [
    ...
    },
    {
      ...
      description: "We foster a community built on mutual respect, where diversity is celebrated and every individual is valued for their unique contributions.",
      examples: [
    ...
    },
    {
      ...
      description: "We embrace creativity and forward-thinking approaches to prepare our students for an ever-changing world.",
      examples: [
    ...
    },
    {
      ...
      description: "We believe in the power of yet - that abilities can be developed through dedication, hard work, and a positive attitude toward learning from mistakes.",
      examples: [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-blue-800 text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-center">Our Values in Action</h1>
          <p className="text-xl text-center mt-4 max-w-3xl mx-auto">
            At our school, we don't just talk about values - we live them every day. 
            Discover how our core principles shape everything we do.
          </p>
        </div>
      </div>
            ...
            >
              ...
              {activeValue === value.id && (
                <div className="px-6 pb-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg mb-2">How We Live This Value:</h4>
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Our Community Speaks</h2>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow">
              <p className="italic text-gray-700 mb-4">"Our school's commitment to excellence has pushed me to achieve things I never thought possible. The teachers believe in us and help us grow every day."</p>
              <p className="font-semibold">- Sarah J., 12th Grade Student</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow">
              <p className="italic text-gray-700 mb-4">"I've watched my son develop not just academically, but as a person with strong values and character. The school's focus on integrity and respect is evident in everything they do."</p>
              <p className="font-semibold">- Michael P., Parent</p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow">
              <p className="italic text-gray-700 mb-4">"Having taught at several schools, I can say that the innovation and growth mindset here creates an exceptional learning environment where both students and faculty thrive."</p>
      ...
      <div className="py-16 container mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold mb-6">Experience Our Values Firsthand</h2>
