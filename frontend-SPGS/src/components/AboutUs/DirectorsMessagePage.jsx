        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none ">
            <div className="relative mb-10 shadow-2xl m-2.5 p-6 bg-white rounded-lg">
              ...
              <p className="mb-4">
                It is with great pleasure that I welcome you to Shree Padmakshi
                Global School, a community of learners dedicated to academic
                excellence, personal growth, and social responsibility.
              </p>

              <p className="mb-4">
                At Shree Padmakshi Global School, we believe that education
                should be a transformative experience .That prepares students
                for success in an ever-changing world. We strive to instil in
                our students a love of learning, a strong sense of values, and
                the skills and confidence to make a positive impact in their
                communities.
              </p>

              <p className="mb-4">
                I invite you to explore our prospectus and discover the many
                opportunities and experiences that Shree Padmakshi Global School
                has to offer. I am confident that our school community will
                provide your child with a rich and rewarding educational
                experience
              </p>

              <p className="mb-2">
                Thank you for considering Shree Padmakshi Global School as your
