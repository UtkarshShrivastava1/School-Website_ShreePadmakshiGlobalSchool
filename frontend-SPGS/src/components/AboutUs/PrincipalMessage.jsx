            ...
            <div className="md:flex">
              ...
              <div className="md:w-2/3 p-6 md:p-10">
                <div className="prose max-w-none">
                  ...
                  <p className="mb-4">
                    I am delighted to welcome you to Shree Padmakshi Global
                    School, a vibrant and inclusive community of learners. As
                    Principal, I am committed to providing a world-class
                    education that prepares students for success in an
                    ever-changing world.
                  </p>

                  <p className="mb-4">
                    At Shree Padmakshi Global School, we believe that every
                    child is unique and deserves a personalized learning ,
                    experience. Our dedicated and experienced faculty are
                    passionate about teaching and learning, and are committed to
                    helping each student reach their full potential.
                  </p>

                  <p className="mb-4">
                    Our school offers a rigorous and well-rounded curriculum,
                    state-of-the-art facilities, and a wide range of
                    extracurricular activities. We strive to create a safe,
                    supportive, and inclusive environment that fosters social,
                    emotional, and academic growth.
                  </p>

                  <p className="mb-4">
                    As you explore our prospectus, I invite you to discover the
                    many opportunities and experiences that Shree Padmakshi
                    Global School has to offer. I am confident that our school
                    community will provide your child with a rich and rewarding
                    educational experience.
                  </p>

                  <p className="mb-6">
                    I invite you to explore our website to learn more about our
                    programs, achievements, and the vibrant community that makes
                    our school special. Should you have any questions or wish to
                    visit our campus, please do not hesitate to contact us.
                  </p>
                  <p className="mb-2">
                    Thank you for considering Shree Padmakshi Global School as
                  ...
                  <p className="text-sm text-muted-foreground">
                    Principal, Shree Padmakshi Global School
                  </p>
                </div>
