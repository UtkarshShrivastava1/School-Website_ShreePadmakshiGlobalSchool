    ...
    <div className="min-h-screen bg-gray-50 font-sans">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 text-white mb-10 md:mb-0">
              ...
              <p className="text-xl text-white">
                Words of wisdom and vision from our leader
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-16 transform -translate-y-16">
            <div className="bg-blue-50 p-8 text-center">
              ...
              <p className="text-red-600  text-lg mt-2">
                Director,Shree Padmakshi Global School Bilaspur
              </p>
            </div>
          ...
          <div className="prose prose-lg max-w-none ">
            <div className="relative mb-10 shadow-2xl m-2.5 p-6 bg-white rounded-lg">
              ...
              <p className="mb-4">
                It is with great joy and enthusiasm that I welcome you to our
                vibrant school community. As the Director, I am truly honored to
                extend a warm greeting to you and your child as we embark on an
                exciting journey of learning and growth.
              </p>

              <p className="mb-4">
                Our school is not just an institution; it is a foundation-laying
                medium where young minds are nurtured and prepared for the
                challenges of tomorrow. With our commitment to academic
                excellence, we offer a comprehensive English medium CBSE
                curriculum designed to foster intellectual curiosity,
                creativity, and critical thinking. At the heart of our mission
                is a focus on holistic development, ensuring that every student
                thrives academically, socially, and emotionally
              </p>

              <p className="mb-4">
                We believe that the partnership between school and parents is
                vital for the success of every child. As we work together to
                shape the future of our students, we remain dedicated to
                providing a safe, supportive, and inspiring environment where
                they can explore, discover, and realize their full potential.
              </p>

              <p className="mb-2">
                Thank you for entrusting us with your child's education. We look
                forward to working alongside you in nurturing the leaders,
                thinkers, and innovators of tomorrow.
              </p>

              <p className="mb-2">Warm regards,</p>
              <p className="italic font-medium">Dr. Vinod Tiwari</p>
              <p className="text-sm text-muted-foreground">
                Director, Shree Padmakshi Global School
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-orange-500">
                ...
                <p className="text-gray-700">
                  The ambience of the school is away from the hustle and bustle
                  of city life and is congenial for academics. The school is
                  equipped with world class ultra modern learning facilities.
                  The classrooms are fully Air conditioned, spacious and
                  equipped with all modern facilities of smart classes.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-orange-500">
                ...
                <p className="text-gray-700">
                  At Shree Padmakshi Global School, Bilaspur we believe that
                  every child has a right to live in calm, orderly, safe and
            ...
            <div className="bg-blue-50 p-8 rounded-lg border-l-4 border-orange-500 flex items-start">
              ...
              <div>
                <p className="text-gray-800 mb-2">
                  I feel proud to state that school is adequately equipped to
                  offer your child the best scholastic training with the help of
                  dedicated team of qualified staff. We look forward for your
                  association and continuous support.
                </p>
      ...
      <div className="bg-[#191f5d] text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-8 text-blue-100">
            Visit our campus to see how we're creating a nurturing environment
      ...
      <div className="container mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-16">
          Our Journey Under Dr. Tiwari's Leadership
        </h2>
            ...
            {[
              {
                ...
                description:
                  "Shree Padmakshi Global School Bilaspur was established",
              },
              {
                year: "2016",
                title: "Infrastructure Expansion",
                description: "Addition of state-of-the-art facilities",
              },
              {
                year: "2018",
                title: "Educational Excellence",
                description: "Recognition for academic achievements",
              },
              {
                year: "2021",
                title: "Digital Transformation",
                description: "Implementation of advanced smart classrooms",
              },
            ].map((item, index) => (
              <div
                key={index}
