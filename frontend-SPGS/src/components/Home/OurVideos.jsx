...
const SchoolHeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Inspiring <span className="text-yellow-400">Excellence</span> in
              Every Student
            </h1>
            <p className="text-lg md:text-xl opacity-90 max-w-lg">
              Our innovative approach to education combines academic rigor with
      ...
      <div
        ref={statsRef}
        className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 md:mt-0"
      >
