...
const MountLiteraZeeSchools = React.lazy(() => import('./pages/About/MountLiteraZeeSchools'));
const OurMission = React.lazy(() => import('./pages/About/OurMission'));
const OurVision = React.lazy(() => import('./pages/About/OurVision'));
const DirectorMessage = React.lazy(() => import('./pages/About/DirectorMessage'));
const PrincipalMessage = React.lazy(() => import('./pages/About/PrincipalMessage'));
const ValueEducation = React.lazy(() => import('./pages/About/ValueEducation'));
const WhyMLZS = React.lazy(() => import('./pages/WhyUs/WhyMLZS'));
const AcademicsPrePrimary = React.lazy(() => import('./pages/WhyUs/AcademicsPrePrimary'));
const AcademicsPrimary = React.lazy(() => import('./pages/WhyUs/AcademicsPrimary'));
const AcademicsMiddle = React.lazy(() => import('./pages/WhyUs/AcademicsMiddle'));
const AcademicUpper = React.lazy(() => import('./pages/WhyUs/AcademicUpper'));
const BeyondAcademics = React.lazy(() => import('./pages/WhyUs/BeyondAcademics '));

const GuidelinesProcedures = React.lazy(() => import('./pages/Admissions/GuidelinesProcedures'));
const SchoolRulesRegulations = React.lazy(() => import('./pages/Admissions/SchoolRulesRegulations'));
const WithdrawalPolicy = React.lazy(() => import('./pages/Admissions/WithdrawalPolicy'));
...
const HiTechClasses = React.lazy(() => import('./pages/Facilites/HiTechClasses'));
const Faculty = React.lazy(() => import('./pages/Facilites/Faculty'));
const SecurityCCTVSurveillance = React.lazy(() => import('./pages/Facilites/SecurityCCTVSurveillance'));
const SportFacilities = React.lazy(() => import('./pages/Facilites/SportFacilities'));
const TransportFacilities = React.lazy(() => import('./pages/Facilites/TransportFacilities'));
const ITInfrastructure = React.lazy(() => import('./pages/Facilites/ITInfrastructures'));
const Extracurricular = React.lazy(() => import('./pages/Facilites/Extracurricular_activities'));

const SchoolCalendar = React.lazy(() => import('./pages/ParentsCorner/SchoolCalendar'));
const FeeStructure = React.lazy(() => import('./pages/ParentsCorner/FeeStructure'));
...
const SchoolNotification = React.lazy(() => import('./pages/ParentsCorner/SchoolNotification'));
const EPFUTURE = React.lazy(() => import('./pages/ParentsCorner/EPFUTURE'));
const ParentVisitingHours = React.lazy(() => import('./pages/ParentsCorner/ParentVisitingHours'));
const Accolades = React.lazy(() => import('./pages/ParentsCorner/Accolades'));
const HouseSystem = React.lazy(() => import('./pages/ParentsCorner/HouseSystem'));
const ViewIssuedTcs = React.lazy(() => import('./pages/ParentsCorner/ViewIssuedTcs'));
const GuidelinesForParents = React.lazy(() => import('./pages/ParentsCorner/GuidelinesForParents'));

const StudentGuidelines = React.lazy(() => import('./pages/StudentCorner/StudentGuidelines'));
const SchoolUniform = React.lazy(() => import('./pages/StudentCorner/SchoolUniform'));
const SchoolTiming = React.lazy(() => import('./pages/StudentCorner/SchoolTiming'));
const AttendancePolicyS = React.lazy(() => import('./pages/StudentCorner/AttendancePolicyS'));
...
const MandatoryDisclosure = React.lazy(() => import('./pages/MandatoryDisclosure/MandatoryDisclosure'));
...
const GalleryDashboard = React.lazy(() => import('./pages/Admin/GalleryDashboard'));

const Director_1_Message = React.lazy(() => import('./pages/About/Director_1Message'));

const Navbar = React.lazy(() => import('./components/Home/Navbar'));
const Footer = React.lazy(() => import('./components/Home/Footer'));
const SchoolValuesPage = React.lazy(() => import('./components/AboutUs/ValuesInAction'));
...
<<<<<<< HEAD
      ...
      <Suspense fallback={<div className='flex justify-center items-center h-screen  text-blue-600 font-stretch-expanded   text-3xl'>
...
=======
      {" "}
      <ScrollToTop /> {!isAdminRoute && <Navbar />}
      <Routes>
        {/* HOME  */}
>>>>>>> cbdd66aaae07f5c8c05374282cc22b411a36a1db
