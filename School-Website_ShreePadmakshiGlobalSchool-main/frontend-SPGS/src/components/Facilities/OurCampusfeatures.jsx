  ...
  const features = [
    {
      ...
      description: "Spacious and well-lit classrooms equipped with Interactive  Smart Panels and advanced educational software to enhance the learning experience.",
      bgColor: "bg-blue-100",
    },
    {
      icon: (
