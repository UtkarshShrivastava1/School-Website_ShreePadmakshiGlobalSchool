...
import ChecmLab from "../assets/LabAndLibrary/ChemLab7.jpg"
import ChecmLab1 from "../assets/LabAndLibrary/ChemLab6.jpg"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              ...
              package of teaching, learning and assessment is delivered through the experiential learning  the child is
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md transition-all hover:shadow-lg">
              ...
              <p className="text-gray-600">
                A comprehensive approach that combines teaching, learning, and assessment through the experiential learning 
                 method.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              All the students are divided into  four houses and they are given opportunities to compete
